...
for parameter in parameter_points:
    ...
    for i, name in enumerate(parameter_names):
        ...
        if i == 0:
            ...
            coordinate_response = recastapi.request.add_coordinate(parameter_id=point_response_id,
...
for coordinates, filename in files.iteritems():
    ...
    file_response = recastapi.request.upload_file(parameter_id=point_request_id,
                                                            filename=filename)
