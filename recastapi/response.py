...
def add_point_response(yaml_file, filename):
	f = open(yaml_file)
	...
	try:
		payload = {
			'scan_response_id': int(data_map['response_id']),
...
def add_basic_response(yaml_file, filename):
	...
	try:
		payload = {
			'lower_1sig_expected_CLs': data_map['lower_1sig_expected_CLs'],
			'lower_2sig_expected_CLs': data_map['lower_2sig_expected_CLs'],
			'expected_CLs': data_map['expected_CLs'],
			'upper_1sig_expected_CLs': data_map['upper_1sig_expected_CLs'],
			'upper_2sig_expected_CLs': data_map['upper_2sig_expected_CLs'],
			'observed_CLs': data_map['observed_CLs'],
			'point_response_id': data_map['point_response_id']
		}
	except Exception, e:
		print "*"*60
		print "File not correctly formatted: ", e
