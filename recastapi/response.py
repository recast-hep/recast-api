...
def add_point_response(lumi_weighted_efficiency, 
                       luminosity,
                       lower_1sig, 
                       upper_1sig,
                       lower_2sig, upper_2sig, 
                       signal_template,
                       log_likelihood,
                       model_id,
                       response_id,
...
def add_basic_response(efficiency=None, 
                       luminosity=None,
                       lower_1sig=None, 
                       upper_1sig=None,
                       lower_2sig=None, 
                       upper_2sig=None, 
                       lower_1sig_rate=None,
                       upper_1sig_rate=None,
                       lower_2sig_rate=None, 
                       upper_2sig_rate=None, 
                       log_likelihood=None,
                       reference_cross_section=None,
                       model_id=None,
                       point_response_id=None, 
                       basic_request_id=None):
    """Adds basic response.
...
def upload_file(basic_response_id,
                file_name, 
                point_response_id=None, 
                file_path=None,
                histo_name=None,
...
def download(response_id, point_response_index=0, basic_response_index=0, download_path=None):
    ...
    response = download_archive(response_basic['_items'][basic_response_index]['id'],
                              download_path)
    return response
